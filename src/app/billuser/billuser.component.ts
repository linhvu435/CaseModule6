...
export class BilluserComponent implements OnInit{
  ...
  ngOnInit() {
    localStorage.setItem("token","eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJsaW5oMTIiLCJpYXQiOjE2NzMzMTY1ODIsImV4cCI6ODgwNzMzMTY1ODJ9.ITUru9T9a18eohxIIUTD6HpTzMAP3EmiqV1IcqWY0UWmFOUwIDxUJ9xKGmGCbeSsnRpfaLbYLr5a7GbN8GUr_w");
    this.showbillshop1
  }
